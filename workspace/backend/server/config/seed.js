...
var Auditlog = require('../api/auditlog/auditlog.model');
...
var auditlogSeed = require('../api/auditlog/auditlog.seed.json');
...
Auditlog.find({}).remove(function() {
	Auditlog.create(auditlogSeed);
});
