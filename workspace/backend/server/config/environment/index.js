...
var all = {
  ...
  facebook: {
    ...
    callbackURL:  'https://nodestage.docintact.com/auth/facebook/callback'
  ...
  twitter: {
    ...
    // callbackURL:  (process.env.DOMAIN || '') + '/auth/twitter/callback'
        callbackURL:  'https://nodestage.docintact.com/auth/twitter/callback'
  ...
  google: {
    ...
    callbackURL:  'https://nodestage.docintact.com/auth/google/callback'
