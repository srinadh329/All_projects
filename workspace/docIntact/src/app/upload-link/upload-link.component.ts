...
export class UploadLinkComponent implements OnInit {
  ...
  constructor(private documentService: DocumentService, public activatedroute: ActivatedRoute,private http:HttpClient,public dialog: MatDialog) {
    this. getLocation();
   }
  signatureImage = null;
  paramid;
  ...
  ngOnInit() {    
    ...
    console.log(this.mobileLinkData)
    this.getLocation();
  }
      ...
      this.documentService.saveSignatureimages(signatureData).subscribe((data: any) => {
        if (data) {
          ...
          this.documentService.updateMobileLink(this.mobileLinkData).subscribe(res => {
            ...
            // this.savedocLogs(this.mobileLinkData,data, this.mobileLinkData.type)
      ...
      this.documentService.saveStampimages(formData).subscribe(data => {
        if (data) {
          ...
          this.documentService.updateMobileLink(this.mobileLinkData).subscribe(res => {
            ...
            // this.savedocLogs(this.mobileLinkData,data, 'Stamp')
          })
        }
      })
    }
  ...
  setPhoto() {
    ...
    if (data && this.mobileLinkData) {
      ...
      this.documentService.updateMobileLink(this.mobileLinkData).subscribe(res => {
        ...
        if(this.locationInfo)this.mobileLinkData.IpAddress=(this.locationInfo)? this.locationInfo.ip:'not Avilable'
        // this.savedocLogs(this.mobileLinkData,res, 'Photo')
      })
    }
  }
