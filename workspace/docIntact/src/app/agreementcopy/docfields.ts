export class DocFields {
    ...
    editIcons = [
      ...
      ConfigFields = [
        {
          ...
          class:'black-colr',
          healpText: 'This Emial Id person only can able to access this field'
        },
        {
          name: 'Font Family',
          type: 'dropdown',
      ...
      },
      {
        ...
        key: 'minlength',
        fType: 'text,company,name,email,mobilenumber',
      ...
      ,{
        ...
        key: 'restrict',
        healpText: 'Ristrict this filed for readonly or required',
