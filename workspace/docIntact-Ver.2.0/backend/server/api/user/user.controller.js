    ...
    if (newpass) {
        User.findOne({ _id: decryptid }, '-salt -hashedPassword', function(err, user) {
            ...
            user.save(function(err, users) {
                ...
                HelperOptions.html = '<table class="main" width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#F4F7FA" style="border: 1px solid #DADADA;max-width: 680px;"'+
                ' >'+

                 '<tr> <td colspan="3" height="112" align="center" valign="middle"> <a href="'+config.frontendUrl+'"><img src='+'"'+config.frontendUrl+'/assets/images/Group2244.png" alt=""></a></td></tr>'+

                 '<tr><td align="center" valign="top" class="" width="50" style="width: 50px;"> &nbsp;</td><td align="center" valign="top" class="" width="50" height="780" style="border-radius:6px; background: #fff; width: 640px;  padding-left: 20px; padding-right:20px;">'+


                 '<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"> <tr><td align="left" valign="top"><div class="row-header" style="color: #000000;font-size: 24px;text-align: center;margin-top: 20px !important;margin-bottom: 30px !important;"> <p style=" margin: 0;line-height: 1.5;color:#000 !important;">Welcome !</p> </div></td></tr>'+


                 '<tr><td align="left" valign="top" ><div class="start-content" style="padding-left:34px; padding-right:34px;color: #000000;font-size: 16px;text-align: left;font-family: "Poppins", sans-serif;"> <p style="margin: 0;line-height: 1.5;color:#000 !important;">'+user.name+',Good Day</p> <p class="p-mrg" style="margin-bottom: 30px !important;margin-top: 20px !important;margin: 0 !important;line-height: 1.5;color:#000 !important;"> Thank you for registering with DOC INTACT. Your account has been activated successfully. You may now login to <a href="'+config.frontendUrl+'">www.docintact.com</a> with your credentials .</p> </div></td></tr>'+


                 '<tr> <td align="left" valign="top" height="30">&nbsp;<hr style="border: 0.5px solid #d5d5d5;"></td> </tr> <tr> <td align="center" valign="top"><div class="row-sub"><p style="color: #000 !important;font-size: 16px;text-align: center;font-family: "Poppins", sans-serif;margin: 0 !important;line-height: 1.5;"><b style="color:#000;">Our Beloved Features</b></p></div></td> </tr>'+


                 '<tr><td align="left" valign="top" height="40">&nbsp;</td> </tr>'+


                 '<tr><td align="left" valign="top"> <table style="width:100%; " width="100%" border="0" align="left" cellpadding="0"cellspacing="0" class="first-row"> <tbody>'+


                 '<tr><td style="padding-left:34px;"> <div><img src='+'"'+config.frontendUrl+'/assets/images/welcomeimg.png"> </div></td>'+

                 
                 '<td style="padding-right:59px;"><div class="row-subr"><p style="color: #000 !important;font-size: 16px;font-family: "Poppins", sans-serif;text-align: left;padding-left: 36px;margin-bottom: 10px !important;margin: 0 !important;line-height: 1.5;"><b style="color:#000 !important;">Access Your Files Anywhere</b></p></div><div class="row-parar" style="padding-right: 25px;"><p style="color: #000 !important;font-size: 10px;font-family: "Poppins", sans-serif;padding-left: 36px;margin: 0;line-height: 1.5;">Lorem Ipsum is simply dummy text of the printing and typesetting industry specimen book.</p> </div></td></tr>'+
                 '</tbody></table ></td> </tr><tr><td align="left" valign="top" height="40">&nbsp;</td></tr><tr><td align="left" valign="top"><table style="width:100%;" width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="first-row">'+
                  '<tbody><tr><td style="padding-left:59px;"><div class="text1"><div class="row-subl"><p style="color: #000000;font-size: 16px;font-family: "Poppins", sans-serif;text-align: right;padding-right: 36px;margin-bottom: 10px !important;"><b>Id Based User Identification</b></p> </div>'+
                  '<div class="row-paral"><p style="color: #000000;font-size: 10px;font-family: "Poppins", sans-serif;text-align: right;padding-right: 36px;">Lorem Ipsum is simply dummy text of the printing and typesetting industry specimen book.</p></div></div><div class="image1" style="visibility: hidden;float: left;width: 0;height: 0;overflow: hidden;"><img src='+'"'+config.frontendUrl+'/assets/images/welcomeimg1.png"></div></td>'+
                  '<td style="padding-right:34px;"><div class="image2" style="overflow: visible;float: none;visibility: visible;"><img src='+'"'+config.frontendUrl+'/assets/images/welcomeimg1.png"></div> <div class="text2" style="visibility: hidden;float: left;width: 0;height: 0;overflow: hidden;"> <div class="row-subl"><p><b>Id Based User Identification</b></p></div><div class="row-paral"><p>Lorem Ipsum is simply dummy text of the printing and typesetting industry specimen book.</p>'+
                  '</div> </div></td></tr></tbody></table></td></tr>'+
                  '<tr><td align="left" valign="top" height="40">&nbsp;</td></tr><tr><td align="left" valign="top"><table style="width:100%;" width="100%" border="0" align="left" cellpadding="0"cellspacing="0" class="first-row"> <tbody><tr><td style="padding-left:34px;"><div><img src='+'"'+config.frontendUrl+'/assets/images/welcomeimg1.png"></div></td>'+
                  '<td style="padding-right:59px;"><div class="row-subr"><p style="color: #000000;font-size: 16px;font-family: "Poppins", sans-serif;text-align: left;padding-left: 36px;margin-bottom: 10px;"><b>Access Your Files Anywhere</b></p></div> <div class="row-parar" style="padding-right: 25px;"><p style="color: #000000;font-size: 10px;font-family: "Poppins", sans-serif;padding-left: 36px;">Lorem Ipsum is simply dummy text of the printing and typesettingindustry specimen book.</p></div></td> </tr>'+
                  ' </tbody></table></td></tr><tr><td align="left" valign="top" height="40">&nbsp;</td></tr>'+
                  '<tr><td align="left" valign="top"><table style="width:100%; margin-bottom:30px;" width="100%" border="0" align="left"cellpadding="0" cellspacing="0" class="first-row"><tbody>'+
                  '<tr><td style="padding-left:59px;"><div class="text1" style="overflow: visible;float: none;visibility: visible;"><div class="row-subl"><p style="color: #000000;font-size: 16px;font-family: "Poppins", sans-serif;text-align: right;padding-right: 36px;margin-bottom: 10px"><b>Id Based User Identification</b></p></div><div class="row-paral">'+
                 '<p style="color: #000000;font-size: 10px;font-family: "Poppins", sans-serif;text-align: right;padding-right: 36px;color:#000 !important;">Lorem Ipsum is simply dummy text of the printing and typesetting industry specimen book.</p> </div> </div><div class="image1" style="visibility: hidden;float: left;width: 0;height: 0;overflow: hidden;"><img src='+'"'+config.frontendUrl+'/assets/images/welcomeimg1.png"> </div></td>'+
                 '<td style="padding-right:34px;"><div class="image2" style="overflow: visible;float: none;visibility: visible;"><img src='+'"'+config.frontendUrl+'/assets/images/welcomeimg.png"></div><div class="text2" style="visibility: hidden;float: left;width: 0;height: 0;overflow: hidden;"><div class="row-subl"><p style="color: #000000;font-size: 16px;font-family: "Poppins", sans-serif;text-align: right;padding-right: 36px;margin-bottom: 10px;"><b style="color:#000 !important;">Id Based User Identification</b></p></div><div class="row-paral"><p style="color:#000 !important;">Lorem Ipsum is simply dummy text of the printing and typesetting industry specimen book.</p></div></div></td></tr></tbody>  </table></td></tr>'+
                 '<tr><td align="left" valign="top" height="20">&nbsp;</td></tr> <tr><td align="left" valign="top"><div class="row-btn" style="text-align:center;"> <a style="    color: #ffffff;background: #0187D1;border-radius: 4px;-moz-border-radius: 4px;-webkit-border-radius: 4px;border-width: 0;padding: 16px 117px;font-size: 16px;font-family: "Poppins", sans-serif;font-weight: 600;text-decoration: none;"> Share Documents Now </button> </a> </td> </tr> <tr><td align="left" valign="top" height="40">&nbsp;</td></tr><tr><td align="left" valign="top"><div class="row-parac" style="text-align:center;"><p style="color:#000 !important;"> If you have any queries please visit our Contact</p><p><a href="#">support@docintact.com</a> </p></div></td></tr> </table></td> <td align="center" valign="top" class="" width="50" style="width: 50px;"> &nbsp;</td></tr>'+
                 '<tr><td colspan="3" height="50" align="center" valign="middle" class="footer-text" style="font-size: 14px;font-family: "Poppins", sans-serif;color: #A2A2A3;font-style: italic;"> <div class="round-brd" style="display: inline-block;font-style: normal;border: 1px solid #A2A2A3;border-radius: 50%;width: 18px;height: 18px;"><p style="font-size: 12px;margin: 0 !important;line-height: 1.5;color:#000 !important;">C</p></div>&nbsp;<p style="display:inline-block;color:#000 !important;">Doc Intact 2019-2020</p></td></tr> </table>'
            ...
            if (user) {
                ...
                if (user.expire_at <= Date.now()) res.json({ "linkstatus": "Link Expired" });
                    ...
                    user.save(function(err, users) {
                        ...
                        if(user.type == 'individual') user.name = user.name
                        else if(user.type == 'organisation') user.name = user.companyname
                        HelperOptions.html = '<table class="main" width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#F4F7FA" style="border: 1px solid #DADADA;max-width: 680px;"'+
                       ' >'+
