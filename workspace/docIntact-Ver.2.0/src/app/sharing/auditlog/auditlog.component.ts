...
export class AuditlogComponent implements OnInit {
  ...
  showvideo(data) {
   ...
   this.videoPlayer .addEventListener('pause', this.videoPause.bind(this)); 
   this.videoPlayer .addEventListener('play', this.videoPlay.bind(this)); 
   this.videoPlayer .addEventListener('muted', this.videoMute.bind(this)); 
