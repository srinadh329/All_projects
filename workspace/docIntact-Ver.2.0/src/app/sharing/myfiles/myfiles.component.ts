...
export class MyfilesComponent implements OnInit, OnDestroy {
  ...
  @HostListener('document:keydown', ['$event']) onKeydownHandler(event: KeyboardEvent) {  
    // if(!this.filesFolders.length && this.startFile)
    // {
    //   this.pushOFTwoDimensional()
    // }

    // if(event.keyCode==39 && event.shiftKey && this.element && this.startFile) {
    //  this.selectWithShiftRight()
    // }
    ...
    // if(event.keyCode==37 && event.shiftKey && this.element && this.startFile) {
    //   this.selectWithShiftLeft()
    // }
